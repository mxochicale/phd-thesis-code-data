...
################################################################################
####  (6)  Writing Data
write.table(xdata, "TidiedInterpolatedTHENpreprocessedData_01.datatable", row.name=FALSE)

message('TidiedInterpolatedTHENpreprocessedData_01.datatable ', 'has been created at '  )
