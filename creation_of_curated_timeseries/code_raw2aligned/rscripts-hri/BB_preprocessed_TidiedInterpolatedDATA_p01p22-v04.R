...
#
### Renaming Sensor Variables
#xdata$Sensor <- gsub('HumanSen1', 'HS01', xdata$Sensor)
#xdata$Sensor <- gsub('HumanSen2', 'HS02', xdata$Sensor)
#xdata$Sensor <- gsub('RobotSen1', 'RS01', xdata$Sensor)
#xdata$Sensor <- gsub('RobotSen2', 'RS02', xdata$Sensor)
...
################################################################################
####  (7)  Writing Data
write.table(xdata, "TidiedInterpolatedTHENpreprocessedData-v04.datatable", row.name=FALSE)
