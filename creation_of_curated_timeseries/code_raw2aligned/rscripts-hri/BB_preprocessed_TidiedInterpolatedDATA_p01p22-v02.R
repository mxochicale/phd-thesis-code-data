...
#
# FileName:
# BB_preprocessed_TidiedInterpolatedDATA_p01p22_01.R
#
# FileDescription: Add Whitening/Sphering data per axis (zero mean and unit variance)
...
################################################################################
### (4.X) Zero mean and unit Variance
###
...
'sgzmuvqW', 'sgzmuvqX', 'sgzmuvqY', 'sgzmuvqZ', 'sg-zmuvAmag','sgzmuvGmag','sgzmuvMmag'
) :=
       lapply(.(AccX, AccY, AccZ, MagnX, MagnY, MagnZ, GyroX, GyroY, GyroZ, qW, qX, qY, qZ,
...
################################################################################
####  (6)  Writing Data
write.table(xdata, "TidiedInterpolatedTHENpreprocessedData-v02.datatable", row.name=FALSE)

message('TidiedInterpolatedTHENpreprocessedData-v02.datatable ', 'has been created at '  )
