...
############AMI CURVES####################
##########################################
#HNAMI <- AMI[Activity=='HNnb', .SDcols=cols  ]
...
#
#
#HFAMI <- AMI[Activity=='HFnb', .SDcols=cols  ]
...
####no BEAT
HNMTD <- MTD[Activity=='HNnb', .SDcols=cols  ]
...
HFMTD <- MTD[Activity=='HFnb', .SDcols=cols  ]
...
filenameimage <- paste(tagfile, "HS02_HNnb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
filenameimage <- paste(tagfile, "HS01_HFnb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
filenameimage <- paste(tagfile, "HS02_HFnb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
##### with BEAT
HNMTD <- MTD[Activity=='HNwb', .SDcols=cols  ]
HS01HNMTD <- HNMTD[sensor=='HS01', .SDcols=cols  ]
pHS01HNMTD <- ggplot(HS01HNMTD, aes(x=participant) ) + 
		geom_point( aes( y=timedelays, colour=factor(participant), shape=factor(participant)  ), size=5 ) +
...
HFMTD <- MTD[Activity=='HFwb', .SDcols=cols  ]
HS01HFMTD <- HFMTD[sensor=='HS01', .SDcols=cols  ]
pHS01HFMTD <- ggplot(HS01HFMTD, aes(x=participant) ) + 
		geom_point( aes(y=timedelays, colour=factor(participant), shape=factor(participant)  ), size=5 ) +
...
filenameimage <- paste(tagfile, "HS01_HNwb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
filenameimage <- paste(tagfile, "HS02_HNwb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
filenameimage <- paste(tagfile, "HS01_HFwb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
...
filenameimage <- paste(tagfile, "HS02_HFwb", tagim, ".png",sep="")
ggsave(filename = filenameimage,
        dpi = dpi,
        width = width.calc,
        height = height.calc,
