...
##VERSION 
version <- '04'
feature_path <- '/utde/rss'
dataset_path <- '/utde/rss/dataset'




## Outcomes Data Path
#outcomes_data_path <- paste(github_path,'/hwum-dataset/data-output/utde', feature_path, '/v', version, sep="")

## Outcomes Plot Path
#outcomes_plot_path <- paste(github_path,'/hwum-manuscript/figures/results/utde', feature_path, '/v', version, sep="")
