...
feature_plot_path <- '/rqa_topologies'
window_path <- '/windows'
#window_path <- '/'
...
## Data Path
data_path <- paste(github_repo_path,'/data-outputs', feature_path, '/v', version, window_path, sep="")
...
plots_path <- paste( outcomes_plot_path, '/', selectParticipant, '/', activitytag, sep='')
