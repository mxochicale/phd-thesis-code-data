...
#activities <- c('VNnb', 'VNwb')
#activities <- c('VFnb', 'VFwb')
activities <- c('VNnb', 'VNwb', 'VFnb', 'VFwb')



setkey(skwkdata, Activity)
skwkdata <- skwkdata[.( activities  )]
...
################# Reorder Factor:
skwkdata$Activity <- factor(skwkdata$Activity)
skwkdata$Activity <- factor(skwkdata$Activity, levels= levels (skwkdata$Activity)[c(3,4,1,2)] )
