...
## Outcomes Plot Path
#outcomes_plot_path <- paste(github_path,'/hwum-manuscript/figures/results', feature_path, '/v', version,  feature_plot_path, sep="")
outcomes_plot_path <- paste(github_path,"/phd-thesis/figs/results", feature_path, '/v', version, feature_plot_path, sep="")

## Data Path
#data_path <- paste(github_path,'/hwum-dataset/data-output', feature_path, '/v', version,  feature_path, sep="")
